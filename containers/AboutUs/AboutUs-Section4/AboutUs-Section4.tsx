                ...
                <Container>
                    <Row className={styles["AboutUs-Section4-Row-Container"]}>
                        ...
                        <Col md={6} className={styles["AboutUs-Section4-ColumnContainer"]}>
                            ...
                            <p className={styles["AboutUs-Section4-Desc"]}>
                                Among our respective clients and partners are the Indonesia's National Police (POLRI); NVIDIA; State-Owned Toll Operator "Jasa Marga"; HP Enterprise; IBM; Asian Games 2018 Committee; and The IMF-World Bank
                                2018 Committee.
                            </p>
                        </Col>
                    </Row>
